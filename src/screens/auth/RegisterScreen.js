    ...
    >
      ...
      >
        ...
        <View style={styles.toggleContainer}>
          <TouchableOpacity
            style={[styles.toggleBtn, userType === 'buyer' && styles.toggleBtnActive]}
            onPress={() => setUserType('buyer')}
          >
            <Text style={[styles.toggleText, userType === 'buyer' && styles.toggleTextActive]}>
              🛒  Buyer
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  decCircle1: {
    ...
    backgroundColor: '#1D4ED8', top: -25, right: -15, opacity: 0.5,
  },
  decCircle2: {
    position: 'absolute', width: 70, height: 70, borderRadius: 35,
    backgroundColor: '#1E40AF', bottom: -15, left: -10, opacity: 0.4,
  },
  iconBox: {
  ...
  inputWrapper: {
    ...
    backgroundColor: '#F9FAFB', marginBottom: 14, overflow: 'hidden',
  },
  inputPrefix: {
