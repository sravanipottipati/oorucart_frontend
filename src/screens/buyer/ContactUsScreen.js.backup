...
import {
  View, Text, ScrollView, TouchableOpacity, StyleSheet, SafeAreaView, Linking, Alert,
} from 'react-native';
...
const WEBSITE         = 'https://www.univerin.in';

const openWhatsApp = () => {
  const msg = 'Hi, I need help with Univerin.';
  const url = `whatsapp://send?phone=${WHATSAPP_NUMBER}&text=${encodeURIComponent(msg)}`;
  Linking.canOpenURL(url)
    .then(supported => {
      if (supported) Linking.openURL(url);
      else Linking.openURL(`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(msg)}`);
    })
    .catch(() => Alert.alert('Error', 'Could not open WhatsApp'));
};

const openEmail = () => {
  Linking.openURL(`mailto:${SUPPORT_EMAIL}?subject=Univerin Support`)
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <View style={styles.banner}>
          ...
          <Text style={styles.bannerSub}>Reach us anytime on WhatsApp</Text>
        </View>
        ...
        <View style={styles.contactCard}>
          ...
          <TouchableOpacity style={styles.contactItem} onPress={openWhatsApp}>
            ...
            <View style={styles.contactInfo}>
              ...
              <Text style={styles.contactHint}>Usually replies in minutes</Text>
            </View>
          ...
          <TouchableOpacity style={styles.contactItem} onPress={openWebsite}>
            <View style={[styles.contactIconBox, { backgroundColor: '#f5f3ff' }]}>
              <Text style={styles.contactIcon}>🌐</Text>
            </View>
            <View style={styles.contactInfo}>
              <Text style={styles.contactTitle}>Website</Text>
              <Text style={styles.contactSub}>www.univerin.in</Text>
              <Text style={styles.contactHint}>Visit our website</Text>
            </View>
            <Ionicons name="chevron-forward" size={20} color="#9CA3AF" />
          </TouchableOpacity>
        ...
        <View style={styles.infoCard}>
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoValue}>Univerin Private Limited</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.infoRow}>
            <Text style={styles.infoLabel}>GSTIN</Text>
            <Text style={styles.infoValue}>37AADCU8846J1ZP</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.infoRow}>
            <Text style={styles.infoLabel}>Address</Text>
            <Text style={styles.infoValue}>4/11, Sankarapuram, Govindampalli, Obulavaripalle - 516105, AP</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.infoRow}>
